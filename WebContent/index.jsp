...
<div class="login-wrap">
  <table width="100%" border="0" cellspacing="0" cellpadding="0">
    ...
    <tr>
      <td><input name="userName" type="text" class="login_input login_user" value="admin" /></td>
    </tr>
    <tr>
      <td height="35" valign="bottom">密  码：</td>
    </tr>
    <tr>
      <td><input type="password" name="psw" class="login_input login_password" value="123" /></td>
    </tr>
    <tr>
      <td height="60" valign="bottom"><button type="submit">登录</button></td>
    </tr>
